...
namespace NXDSteamPlugin.Services.Processes
{
    ...
    {
        public GameActionResult UninstallEntry(SteamPlugin plugin, LibraryEntry entry, CancellationToken cancellationToken)
        {
            try
            {
        ...
        private async UniTask MonitorGameUninstallation(SteamPlugin plugin, LibraryEntry entry, CancellationToken cancellationToken)
        {
            LibraryEntry game;
