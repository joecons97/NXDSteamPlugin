...
namespace NXDSteamPlugin.Services.Processes
{
    public class StartEntryService
    {
        ...
        public GameActionResult StartEntry(SteamPlugin plugin, LibraryEntry entry, CancellationToken cancellationToken)
        {
        ...
        private async UniTask MonitorGameDirectoryAsync(SteamPlugin plugin, LibraryEntry entry, CancellationToken cancellationToken)
        {
